...
class MeService:
    ...
    async def get_bootstrap(
        ...
        *,
        ...
        reward_status = await self.get_daily_reward_status(db, user_id=user_id)
        return {
            ...
            "isPro": reward_status.effectiveProActive,
            "membershipTier": reward_status.membershipTier,
            "effectiveMembershipTier": reward_status.effectiveMembershipTier,
            "dailyReward": reward_status.model_dump(mode="json"),
        }
